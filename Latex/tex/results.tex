...
\begin{figure}
	...
	\subfigure[Overall Simulation Time]{
		\includegraphics[width=.45\linewidth]{img/simTime.eps}
	}
	\hfill
	\subfigure[Kominakis Simulation Time]{
		\includegraphics[width=.45\linewidth]{img/simTime_Komninakis.eps}
	}
	\hfill
	
	\caption{Simulation time for the simulators}
	\label{fig:simTime}
\end{figure}